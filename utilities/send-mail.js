...
exports.notice = (comment) => {
    ...
    let emailSubject = '👉 Dear master,「' + process.env.SITE_NAME + '」has a new comment!';
...
exports.send = (currentComment, parentComment)=> {
    ...
    let emailSubject = '👉 Dear @visitor, your comment on「' + process.env.SITE_NAME + '」got a new reply!';
